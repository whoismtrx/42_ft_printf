...
#    Updated: 2022/01/12 06:08:26 by orekabe          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =	ft_printf.c ft_putchar.c ft_putstr.c ft_putnbr.c ft_puthex.c ft_putaddress.c ft_fill.c \
		...
		ft_putnchar.c ft_putnstr.c ft_putnnbr.c ft_putunbr.c ft_putnhex.c ft_putnaddress.c ft_atoi.c ft_strlen.c 
